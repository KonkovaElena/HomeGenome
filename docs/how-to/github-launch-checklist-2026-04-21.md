...
| Short description | `Research-grade reference documentation for local, air-gapped home genome sequencing with Oxford Nanopore, modern nanopore analysis, and AI-assisted interpretation.` |
...
1. Add repository URL fields to `CITATION.cff` after the final GitHub remote is created.
2. Add lightweight docs CI for markdown link checking and style validation.
3. Create a social preview image only after the public narrative is stabilized.
4. Add release automation and SBOM generation when the repo moves beyond the initial public baseline.
